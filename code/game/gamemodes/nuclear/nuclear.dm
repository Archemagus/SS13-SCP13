...
/datum/game_mode/nuclear/declare_completion()
	...
	if(!disk_rescued &&  station_was_nuked && !syndies_didnt_escape)
		...
		to_world("<B>The Site Staff has saved the disc and killed the [syndicate_name()] Operatives</B>")
		...
		to_world("<B>The Site Staff failed to secure the authentication disk but did manage to kill most of the [syndicate_name()] Operatives!</B>")
