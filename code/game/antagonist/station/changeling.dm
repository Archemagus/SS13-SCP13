...
/datum/antagonist/changeling
	...
	protected_jobs = list(/datum/job/assistant, /datum/job/warden, /datum/job/detective, /datum/job/captain, /datum/job/hos/datum/job/rd, /datum/job/o5rep, /datum/job/commsofficer)
	welcome_text = "Используйте say \",g message\" чтобы св&#255;затьс&#255; с другими Шейпшифтерами (&#255 сам не ебу кто это). Помните: вы получите все поглащенные ими ДНКа, если поглотите их самих.."
